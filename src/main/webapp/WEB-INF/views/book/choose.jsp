	...
	<div class="whos-behind-container">
		<div class="container">
			...
			<form action="choose" method="post">
				<input type="hidden" name="voteBookHistId"
					value="${voteBookHist.id}"> <input type="hidden"
					name="selectedBookId" id="selectedBookId">
				<div class="row">
					<!-- Book FOR - start -->
					<c:forEach items="${ bookList }" var="book" varStatus="status">
						<div class="col-sm-6 whos-behind-box-1">
							<div class="whos-behind-photo vote-book"
								data-book-id="${book.id}" style="height: auto;">
								<img
